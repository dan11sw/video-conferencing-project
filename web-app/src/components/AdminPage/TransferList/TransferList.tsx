...
const headCells: readonly HeadCell[] = [
  ...
  },
  {
    ...
    label: "Кол-во переданных токенов",
    align: "right",
  },
  {
    id: "sender_email",
...
const TransferList: FC<ITransferListProps> = ({ transfers }) => {
  ...
  const emptyRows =
    page > 0
      ? Math.max(
          0,
          (1 + page) * rowsPerPage - transfers.length
        )
      : 0;
    ...
    () =>
      stableSort(
        transfers.map((item) => {
          return {
            ...item,
            sender_email: item.sender_info.email,
            receiver_email: item.receiver_info.email,
          } as Data;
        }),
        getComparator(order, orderBy)
      ).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage),
    [order, orderBy, page, rowsPerPage, transfers]
  );
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.receiver_email}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
